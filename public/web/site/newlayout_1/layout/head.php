    ...
    <title>Krásný nový titulek</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?= Middleware\Web\AppContext::getAppPublicDirectory().'newlayout_1/css/zkouska_less.css'?>" >
