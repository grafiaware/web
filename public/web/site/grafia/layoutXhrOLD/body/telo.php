<div class="ui three column stackable grid equal width">
    <div class="one wide tablet three wide computer column">
        ...
        <div id="component_rychleOdkazy">
            <script>$("#component_rychleOdkazy").load("component/v1/namedpaper/a3");</script>
        </div>
    </div>
    <div id="contents" class="column">
        ...
        <div id="component_presentedpaper">
            <script>$("#component_presentedpaper").load("component/v1/presentedpaper");</script>
        </div>
    ...
    <div class="four wide tablet three wide computer column">
        ...
        <script>$("#component_razitko").load("component/v1/namedpaper/a4");</script>
        </div>
        <div id="component_socialnisite">
        <script>$("#component_socialnisite").load("component/v1/namedpaper/a5");</script>
        </div>
        <div id="component_aktuality">
        <script>$("#component_aktuality").load("component/v1/namedpaper/a1");</script>
        </div>
        <div id="component_akce">
        <script>$("#component_akce").load("component/v1/namedpaper/a2");</script>
        </div>
    </div>
</div>
