...
var selectPaperTemplateConfig = {
    ...
    templates: [
        ...
        { title: 'Test - presentedpaper s šablonou default', description: 'rendered component',       url: 'component/v1/presentedpaper?template=default'},
        { title: 'Test - presentedpaper s šablonou contact', description: 'rendered component',       url: 'component/v1/presentedpaper?template=contact'},
        { title: 'Test - presentedpaper s šablonou test', description: 'rendered component',       url: 'component/v1/presentedpaper?template=test'},
        { title: 'Test - presentedpaper s šablonou course', description: 'rendered component',       url: 'component/v1/presentedpaper?template=course'},
        { title: 'Test - namedpaper a1', description: 'rendered component',       url: 'component/v1/namedpaper/a1'},
        { title: 'Test - namedpaper a2', description: 'rendered component',       url: 'component/v1/namedpaper/a2'},
        { title: 'Test - namedpaper a3', description: 'rendered component',       url: 'component/v1/namedpaper/a3'},
        { title: 'Test - namedpaper a4', description: 'rendered component',       url: 'component/v1/namedpaper/a4'},
        { title: 'Test - namedpaper a5', description: 'rendered component',       url: 'component/v1/namedpaper/a5'},
        { title: 'Test - namedpaper a6', description: 'rendered component',       url: 'component/v1/namedpaper/a6'},
