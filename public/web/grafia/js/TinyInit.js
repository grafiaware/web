...
//       'template textpattern searchreplace image imagetools save example'
    ...
    templates: [
        ...
        { title: 'Ohraničený blok 1', description: 'Obsah s rámečkem', url: tinyConfig.templatesPath + 'ohraniceny_blok.html'},
        { title: 'Ohraničený blok 2', description: 'Obsah s rámečkem', url: tinyConfig.templatesPath + 'ohraniceny_blok2.html'},
        { title: 'Blok s ikonou', description: 'Obsah s ikonou', url: tinyConfig.templatesPath + 'icon_blok.html'},
