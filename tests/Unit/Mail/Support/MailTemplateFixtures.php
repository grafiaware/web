...
//    public static function authMessage_vs(string $filename): string
//    {
//        return self::projectRoot()
//            . '/t/'
//            . $filename;
//    }
    ...
    {
        return ['registerJmeno' => 'navstevnik.test', 'data_logo_klic' => self::LOGO ];
    }
        
    public static function podekovaniEmptyContext(): array
    {
        return ['registerJmeno' => '', 'data_logo_klic' => self::EMPTY_LOGO ];
    }
