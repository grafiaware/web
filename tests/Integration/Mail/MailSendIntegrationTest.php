 ...
 //       try {
    ...
    public function testMailBody_withContextEcxception(): void
    {
        ...
        try {
            ...
            //$this->assertTrue( true, 'Zachycena vyjimka - test na PRAZDNY RETEZEC a NULL v promenne $contextu| '. $e->getMessage() );
            echo "\n[INFO] Vyjimka zachycena, je to OK!\n" .'Zachycena vyjimka - test na PRAZDNY RETEZEC a NULL v promenne $contextu| '. $e->getMessage() ;
            $this->assertTrue(true);
            return;
        }    

// dale je asi zbytecne //
//        
//         $priloha1 = (new Attachment())
//                        ->setFileName($attachmentsDir . 'logo_grafia.png')
//                        ->setAltText('Logo Grafia.png');                    
//         $priloha2 = (new Attachment())
//                        ->setFileName($attachmentsDir . 'sample-catalog.pdf')
//                        ->setAltText('Katalog test.pdf');
