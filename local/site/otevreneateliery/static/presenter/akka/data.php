...
$firma = [
    ...
    'socialniSiteIframe' => [
        ...
        [
            ...
            'iframe' => '<a href="https://www.linkedin.com/company/akka-technologies/" target="_blank"><img src="'.ConfigurationCache::files()['presenter'].$shortName.'/assets/linkedin.png" alt="profil LinkednIn" height="" width="100%"/></a>',
        ...
        [
            ...
            'iframe' => '<a href="https://www.youtube.com/c/akkatechnologies/" target="_blank"><img src="'.ConfigurationCache::files()['presenter'].$shortName.'/assets/youtube.png" alt="profil Youtube" height="" width="100%"/></a>',
