...
$cnt = count($company);
if ($cnt==0) {
    echo "<p>Chyba: Nenalezena company podle textu položky menu '$itemTitle'.</p>";
} elseif($cnt>1) {
    echo "<p>Chyba: Nalezeno více company podle textu položky menu '$name'. Počet nalezených: $cnt.</p>";
} else {
