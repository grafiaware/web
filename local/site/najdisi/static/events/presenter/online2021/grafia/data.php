...
$firma = [
    ...
    'socialniSiteIframe' => [
        ...
        [
            ...
            'iframe' => '<a href="https://cz.linkedin.com/company/grafia-s.r.o./" target="_blank"><img src="'.ConfigurationCache::files()['@presenter']."/".$companyName.'/assets/linkedin.png" alt="profil LinkednIn" height="" width="100%"/></a>',
