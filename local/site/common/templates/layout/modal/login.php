...
?>
    ...
    <form class="ui inverted form centered" method="POST" action="auth/v1/forgottenpassword">
            <div class="ui icon top left pointing dropdown button loginEnterKey">
                <i class="user icon"></i>
                <div class="menu">
                    ...
                    <button class="ui fluid tertiary grey button" type="submit" name="forgottenpassword" value=1>Zapomněl jsem<br/>heslo</button>                     
              </div>
            </div>
    </form>
