    ...
    <div class="ui stackable centered grid">
            ...
            <div class="ui two column grid internally celled stackable centered">
                <div class="seven wide column ">
                    ...
                    <ul>
                        ...
                        <li>Mnohem častěji sáhne zákazník po časopisu než po prospektu</li>
                        <li>Časopis zlepší Vaše image</li>
                ...
                <div class="seven wide column ">
                    ...
                    <ul>
                        ...
                        <li>Servis do nejmenšího detailu</li>
                        <li>Komunikace s jedním dodavatelem, který Vás dobře zná a dobře Vám poradí</li>
                        <li>Sami určujete design a obsah informací</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="sixteen wide column">
            <div class="ui three column grid stackable centered centered-img">
        ...
        <div class="eight wide column centered">
            ...
            <div class="ui piled segment">
                <p class="text velky primarni-barva">Kontakujte nás:</p>
                <p class="text zadne-okraje"><b>Telefon:</b> 378 771 226; 774 484 856</p>
