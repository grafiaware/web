<div class="mceNonEditable">
    <p class="primarni-nadpis nastred nadpis-scroll mceEditable">Název knihy</p>
    <div class="ui stackable centered grid">
        <div class="sixteen wide column">
            <p class="text velky primarni-barva">Anotace knihy</p>
            <div class="text mceEditable">
                <p>
                ...
                Je praktikem, který "bez pláště" předkládá osobní zkušenost s chorobami, o kterých se ve společnosti nemluví příliš nahlas a na které moderní medicína nenalézá účinný lék. Na vlastní kůži prošel dlouhým léčebným procesem se všemi jeho úskalími až k vítěznému konci. Je jedním z mála lékařů, který má odvahu promluvit o procesu uzdravování i z pohledu pacienta. Kniha přináší inspiraci a naději - pacientům i jejich blízkým.
                </p>
                <p>
                MUDr. Tomáš Lebenhart připomíná starý čínský princip, kdy lékař zodpovídal za zdraví celé rodiny, byl oslavován, když rodina byla zdravá a zatracován, když někdo onemocněl.
                Tím, že se s námi dělí o své letité poznatky praktického lékaře, naplňuje ideu prevence a zároveň apeluje na naši osobní odpovědnost za stav vlastního těla i duše. Svou knihou nám dává nahlédnout do svého uvažování o zdraví člověka jako výslednici harmonického chování k sobě i okolí.
                </p>
            </div>
        </div>
        <div class="sixteen wide column">
        ...
        <div class="sixteen wide column">
            <hr/>
            <p class="text zadne-okraje"><b>Termín vydání:</b> <span class="mceEditable"> 1. 12. 2017</span></p>
            <p class="text zadne-okraje"><b>Doporučená maloobchodní cena:</b> <span class="mceEditable"> 980 Kč</span></p>
            <p class="text zadne-okraje"><b>Formát a rozsah publikace:</b> <span class="mceEditable"> A4, 496 stran, pevná knižní vazba, obálka lamino</span></p>
            <p class="text zadne-okraje mceEditable">Speciální nabídka publikací pro podniky <a href="https://form.simpleshop.cz/k4OE/buy/" target="_blank">zde</a></p>
            <p class="text okraje nastred mceEditable">
