    <div class="ui stackable centered grid">
        ...
        <div class="sixteen wide column">
            <div class="">
                ...
                <ul>
                    ...
                    <li>Sestavení obsahu a struktury vzdělávacího programu na základě stanovených vzdělávacích cílů, vč. z nich vyplývajících kompetencí</li>
                    <li>Rozpracování obsahu kurzu do minutového scénáře včetně volby didaktických pomůcek a metod výuky</li>
                    <li>Zjišťování úrovně vstupních kompetencí a vzdělávacích potřeb účastníků vzdělávacího programu</li>
                </ul>
            </div>
        </div>
        <div class="sixteen wide column">
        ...
        <div class="sixteen wide column">
            ...
            <div class="ui segment ">
                ...
                <p class="text zadne-okraje"><i class="address book outline icon"></i> <b>Vstupní požadavky:</b> Střední vzdělání s maturitní zkouškou</p>
                <p class="text zadne-okraje"><i class="map marked alternate icon"></i> <b>Místo konání:</b> Plzeň</p>
                <p class="text zadne-okraje"><i class="money bill icon"></i> <b>Cena:</b> 0000 Kč</p>
                <p class="text nastred"><a class="ui labeled icon primary large button" href=""><i class="pencil alternate icon"></i> Vyplnit přihlášku</a></p>
            </div>
        </div>
        <div class="sixteen wide column">
            <div class="">
                ...
                <p class="text kurziva zadne-okraje">"Lektorka Petra na mne působila jako výborný lektor. Má velmi pěkný přednes. Usměvavá, ve všem nápomocná. Umí poradit, zaujmout. Výborná lektorka."</p>
            </div>
        </div>
    </div>