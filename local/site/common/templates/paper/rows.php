...
use Web\Component\Renderer\Html\Content\Authored\Paper\Buttons;
...
?>
    ...
    <div class="" data-template="<?= "rows" ?>">
        ...
        <div class="ui grid stackable centered">
            <?= $this->repeat(PROJECT_PATH."local/site/common/templates/paper-content/rows.php", $sections, 'paperSection'); ?>
        </div>
    </div>