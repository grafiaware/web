...
?>
        ...
        <?php $formUid= uniqid(); ?>
        <form id="<?= $formUid ?>" class="ui huge form" action="" method="POST" enctype="multipart/form-data" onKeyup="eventsEnableButtonsOnForm(event)" onChange="eventsEnableButtonsOnForm(event)">
