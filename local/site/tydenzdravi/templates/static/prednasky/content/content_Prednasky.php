...
<div class="prednasejici">
    <div class="ui two column internally celled grid centered">
        ...
        <div class="stretched row">
            <div class="eight wide column"><p><b>Anna a Eva Vopalecké</b></p><p><?= $this->mono('lektorky a choreografky Studio FITNESSKA')?></p></div>
            <div class="eight wide column"><p><?= $this->mono('<b>Tančete s námi</b>')?></p>27.11.2020, 19:15<p><a class="ui large secondary button" href="https://forms.gle/aUoufuqLyaSjm6rE8" target="_blank">Přihlásit se / Položit dotaz</a></p></div>
        </div>
    </div>
