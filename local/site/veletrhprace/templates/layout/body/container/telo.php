<div class="obr-upoutavka">
    <div class="ui two column stackable centered grid">
        <div class="sixteen wide column">
            ...
            <img src="@siteimages/pexels-photo-863977-web-orez.jpg" width="100%" height="" />
        </div>
        <div class="ten wide column">
            <img src="@siteimages/pexels-cemal-taskiran-web-orez.jpg" width="100%" height="" />
        </div>
...
<div class="blok-nadpis-obr-text">
    <div class="ui stackable centered grid">
        <div class="sixteen wide column">
            ...
            <img src="@siteimages/pexels-photo-web-orez.jpg" width="100%" height="" />
...
<div class="sekundarni-barva blokEL-obr-text">
    <div class="ui stackable centered grid">
        <div class="sixteen wide column">
            <img src="@siteimages/pexels-andrea-piacquadio-web-orez.jpg" width="100%" height="" />
...
<div class="dva-sloupce-nadpis">
    <div class="ui two column stackable centered grid">
        <div class="six wide column middle aligned">
            <img src="@siteimages/LogoGrafia.jpg" width="300" height="" />
        </div>
        <div class="ten wide column">
            <div class="primarni-barva podklad nadpis vpravo">
                <p>Organizátor</p>
