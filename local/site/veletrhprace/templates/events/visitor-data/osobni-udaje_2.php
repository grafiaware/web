            ...
            <div class="active content">
                <form class="ui huge form" action="" method="POST" enctype="multipart/form-data">                  
                    ...
                    <div class="field margin">
                        <p>
                            <i class="file alternate icon"></i><b>Životopis: <?=  isset($cvDocumentFilename) ?  $cvDocumentFilename : "" ?></b>
                            <?php
                        ...
                        <p><i class="file alternate icon"></i><b>Motivační dopis: <?= isset($letterDocumentFilename) ? $letterDocumentFilename : "" ?></b>
                            <?php
