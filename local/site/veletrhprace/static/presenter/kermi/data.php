...
$firma = [
    ...
    'socialniSiteIframe' => [
        ...
        [
            ...
            'iframe' => '<a href="https://cz.linkedin.com/company/kermi-s-r-o-/" target="_blank"><img src="'.ConfigurationCache::files()['presenter'].$shortName.'/assets/linkedin.png" alt="profil LinkednIn" height="" width="100%"/></a>',
