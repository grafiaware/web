...
define("PES_BOOTSTRAP_LOGS_BASE_PATH", $_SERVER['DOCUMENT_ROOT'].Configuration::bootstrap()['bootstrap.logs.basepath']);  // absolutní cesta k podsložce document root
 ...
 */
define('PES_PRODUCTION_MACHINE_HOST_NAME', Configuration::bootstrap()['bootstrap.productionhost']);  //vp
/*
