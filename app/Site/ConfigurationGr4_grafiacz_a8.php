...
class ConfigurationGr4_grafiacz_a8 {
    ...
    public static function build() {
        return [
            ...
            'build.db.user.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'gr4_upgrader' : 'UPGRADE_BUILD_PRODUCTION_USER',
            'build.db.user.password' => PES_RUNNING_ON_PRODUCTION_HOST ? 'gr4_upgrader' : 'UPGRADE_BUILD_PRODUCTION_HOST',
            #
            ###################################
...
//                ['paper', 'menu_vertical', 'Menu'],      // !! menu menu_vertical je s titulní stranou  -> ve staré db je stránka list=menu_vertical a má titulek
    ...
    public static function dbUpgrade() {
        return [
            ...
            'dbUpgrade.db.connection.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'gr4_upgrade' : 'UPGRADE_PRODUCTION_NAME',
            #
            #  Konec sekce konfigurace databáze
            ###################################
    ...
    public static function hierarchy() {
        return  [
            ...
            # Ostatní parametry konfigurace databáze v kontejneru dbUpgrade
            #
            'dbUpgrade.db.user.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'gr4_upgrader' : 'UPGRADE_PRODUCTION_USER_NAME',
            'dbUpgrade.db.user.password' => PES_RUNNING_ON_PRODUCTION_HOST ? 'gr4_upgrader' : 'UPGRADE_PRODUCTION_USER_PASSWORD',
            #
            ###################################
            # Konfigurace hierarchy tabulek
            #
...
//    <script src="https://cdn.tiny.cloud/1/no-api-key/tinymce/5/jquery.tinymce.min.js" referrerpolicy="origin"></script>
    ...
    public static function transformator() {
        return [
            'filesDirectory' => PES_RUNNING_ON_PRODUCTION_HOST ? '_www_gr4_files/' :  '/_www_gr4_files/',  // relativní cesta vzhledem k DOCUMENT_ROOT (htdocs) -začíná /
        ];
    }
}
