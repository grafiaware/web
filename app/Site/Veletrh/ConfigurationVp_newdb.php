...
class ConfigurationTz_newdb {
    ...
    public static function bootstrap() {
        return [
            'bootstrap_logs_base_path' => "/_www_vp_logs/",
        ];
    }
    ...
    public static function api() {
        return [
            ...
            #
            'api.db.everyone.name' => 'veletrhpraceonline001',
            'api.db.everyone.password' => 'vp_upgrader',
            'api.db.authenticated.name' => 'veletrhpraceonline001',
            'api.db.authenticated.password' => 'vp_upgrader',
            'api.db.administrator.name' => 'veletrhpraceonline001',
            'api.db.administrator.password' => 'vp_upgrader',
            #
            ###################################
            #
    ...
    public static function build() {
        return [
            ...
            'build.db.user.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrh',
            ...
            'build.config.users.everyone' =>
                [
                    'everyone_user' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrh',
                    'everyone_password' => PES_RUNNING_ON_PRODUCTION_HOST ? 'vp_upgrader' : 'vp_upgrader',
                ],
            'build.config.users.granted' =>
                [
                    'authenticated_user' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrh',
                    'authenticated_password' => PES_RUNNING_ON_PRODUCTION_HOST ? 'vp_upgrader' : 'vp_upgrader',
                    'administrator_user' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrh',
                    'administrator_password' => PES_RUNNING_ON_PRODUCTION_HOST ? 'vp_upgrader' : 'vp_upgrader',
                ],
            #
            ###################################
    ...
    public static function dbOld() {
        return [
            ...
            'dbold.db.connection.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrh',
    ...
    public static function dbUpgrade() {
        return [
            ...
            'dbUpgrade.db.connection.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrh',
            #
            #  Konec sekce konfigurace databáze
            ###################################
    ...
    public static function hierarchy() {
        return  [
            ...
            # Ostatní parametry konfigurace databáze v kontejneru dbUpgrade
            #
            'dbUpgrade.db.user.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'veletrhpraceonline001' : 'veletrhpraceonline001',
    ...
    public static function login() {
        return  [
            ...
            'login.db.account.everyone.name' => 'veletrhpraceonline002',  // nelze použít jméno uživatele použité pro db upgrade - došlo by k duplicitě jmen v build create
            'login.db.account.everyone.password' => 'vp_opravneni',
...
//                        'Item' => Configuration::rendererDefaults()['menu_edit_items'],
    ...
    public static function web() {
        return [
            ...
            'web.db.account.everyone.name' => 'veletrhpraceonline001',
            'web.db.account.everyone.password' => 'vp_upgrader',
            'web.db.account.authenticated.name' => 'veletrhpraceonline001',
            'web.db.account.authenticated.password' => 'vp_upgrader',
            'web.db.account.administrator.name' => 'veletrhpraceonline001',
            'web.db.account.administrator.password' => 'vp_upgrader',
            #
            ###################################
        ];
    }
    ...
    public static function rs() {
        return [
            ...
            'rs.db.account.everyone.name' => 'veletrhpraceonline001',
            'rs.db.account.everyone.password' => 'vp_upgrader',
            'rs.db.account.authenticated.name' => 'veletrhpraceonline001',
            'rs.db.account.authenticated.password' => 'vp_upgrader',
            'rs.db.account.administrator.name' => 'veletrhpraceonline001',
            'rs.db.account.administrator.password' => 'vp_upgrader',
            #
            ###################################
