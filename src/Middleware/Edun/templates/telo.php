<div id="col1wrap" class="column">  <!--  col1wrap -->
    <div id="col1pad">   <!-- col1pad -->
        <div id="rs_middle">
            <?php
                if (file_exists(\Middleware\Edun\AppContext::getScriptsDirectory()."edun/$list.php")){
                    include \Middleware\Edun\AppContext::getScriptsDirectory()."edun/$list.php";
                } else {
...
<div id="col2wrap" class="column">   <!-- /** col2wrap**/ -->
    <div id="col2pad">    <!-- /** col2pad**/  -->
        <div id="rs_menu">
            <?php
                include \Middleware\Edun\AppContext::getScriptsDirectory().'menu/menu.php';
            ?>
        </div>   <!-- menu -->
        <hr class="separator" />
    </div><!-- col2pad -->
