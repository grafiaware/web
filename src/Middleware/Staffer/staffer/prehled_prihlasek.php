...
if (isset($_GET['pozice'])) {
    ...
    echo '<H3>Přehled přihlášek na pozici '.$zaznam['nazev'].'</H3>';
    ...
    if (!$statement->rowCount()) {
        echo '<p>Není uložena žádná přihláška.</p>';
    }

    foreach ($statement->fetchAll(PDO::FETCH_ASSOC) as $zaznam) {
        echo '<fieldset><legend>';
            if ($zaznam['precteno'] == 0) {echo '<img src="app/staffer/img/neprecteno.png"> nepřečteno ';}
            ...
            echo 'Přihláška vložena:<br><b>'.$zalozeno.'</b>';
            echo '</DIV>';
