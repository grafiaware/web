...
############ CESTY KE SLOŽKÁM #############################
    ...
    public static function getPublicDirectory() {
        return \AppContext::rootRelativePath().'public/common/';  // relativní cesta vzhledem ke kořenovému adresáři skriptu
    }

    public static function getAppPublicDirectory() {
        return \AppContext::rootRelativePath().'public/staffer/';  // relativní cesta vzhledem ke kořenovému adresáři skriptu
    }

    public static function getScriptsDirectory() {
        return \AppContext::workingPath()."Middleware/Staffer/";  // absolutní cesta vzhledem ke kořenovému adresáři skriptu (index.php)
    }
