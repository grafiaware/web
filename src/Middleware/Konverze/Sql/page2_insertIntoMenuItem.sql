...
INSERT INTO `menu_item` ( `lang_code_fk`, `type_fk`, `list`, `order`,  `title`, `active`, `auto_generated`)
VALUES  ('cs', NULL, 'l', 0, 'Menu l', 1, 0);
INSERT INTO `menu_item` ( `lang_code_fk`, `type_fk`, `list`, `order`,  `title`, `active`, `auto_generated`)
VALUES  ('en', NULL, 'l', 0, 'Menu l', 1, 0);
INSERT INTO `menu_item` ( `lang_code_fk`, `type_fk`, `list`, `order`,  `title`, `active`, `auto_generated`)
VALUES  ('de', NULL, 'l', 0, 'Menu l', 1, 0);

INSERT INTO `menu_item` ( `lang_code_fk`, `type_fk`, `list`, `order`,  `title`, `active`, `auto_generated`)
VALUES  ('cs', NULL, 'p', 0, 'Menu p', 1, 0);
INSERT INTO `menu_item` ( `lang_code_fk`, `type_fk`, `list`, `order`,  `title`, `active`, `auto_generated`)
VALUES  ('en', NULL, 'p', 0, 'Menu p', 1, 0);
INSERT INTO `menu_item` ( `lang_code_fk`, `type_fk`, `list`, `order`,  `title`, `active`, `auto_generated`)
VALUES  ('de', NULL, 'p', 0, 'Menu p', 1, 0);
...
SELECT  'cs' AS lang_code_fk, list, poradi AS `order`, nazev_lan1 AS title, aktiv_lan1 AS active, aut_gen AS auto_generated FROM stranky_innodb
UNION ALL
SELECT  'en' AS lang_code_fk, list, poradi AS `order`, nazev_lan2 AS title, aktiv_lan2 AS active, aut_gen AS auto_generated FROM stranky_innodb
UNION ALL
SELECT  'de' AS lang_code_fk, list, poradi AS `order`, nazev_lan3 AS title, aktiv_lan3 AS active, aut_gen AS auto_generated FROM stranky_innodb
	ORDER BY list ASC;
