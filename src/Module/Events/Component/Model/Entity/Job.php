...
use Events\Component\Model\Entity\JobInterface;
...
class Job extends PersistableEntityAbstract implements JobInterface {
    ...
    private $jobToTagsArray = [];
    private $JobTagsArray = [];
    
    public function getJobToTagsArray() {
        return $this->jobToTagsArray;
    }

    public function setJobToTagsArray($jobToTagsArray) {
        $this->jobToTagsArray = $jobToTagsArray;
        return $this;
    }
    
    public function getJobTagsArray() {
        return $this->JobTagsArray;
    }

    public function setJobTagsArray($JobTagsArray) {
        $this->JobTagsArray = $JobTagsArray;
        return $this;
    }
