...
CHANGE COLUMN `api_generator_fk` `api_generator_fk` VARCHAR(20) NULL DEFAULT NULL AFTER `api_module_fk`,
...
ADD CONSTRAINT `menu_item_api_fk`
  ...
  REFERENCES `veletrhprace`.`menu_item_api` (`module` , `generator`)
  ON DELETE RESTRICT
  ON UPDATE CASCADE;

INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('red', 'article');
INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('red', 'paper');
INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('red', 'multipage');
INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('red', 'static');
INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('events', 'static');
INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('auth', 'static');
INSERT INTO `veletrhprace`.`menu_item_api` (`module`, `generator`) VALUES ('red', 'empty');
