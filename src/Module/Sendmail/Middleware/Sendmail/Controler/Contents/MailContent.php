...
//        $this->registrationRepo = $registrationRepo;
    ...
    public function getParams($assembly, $mailAdresata, $jmenoAdresata) {
        ...
        switch ($assembly) {
            case 'Jedna':
                    $subject =  "Předmět prvního mailu";                                        
                    $body = $this->htmlMessageFactory->create(__DIR__."/Messages/$assembly.php",
                    ...
                    $params = (new Params())
                        ->setContent(  (new Content())
                                     ->setSubject("Předmět prvního mailu")
                                     ->setHtml($body)
                        ...
                        ->setParty  (  (new Party())
                                     ...
                                     ->addCc( 'webmaster@grafia.cz', 'Kopie')   
