...
//        $this->registrationRepo = $registrationRepo;
    ...
    public function getParams($assembly, $adresat) {
        ...
        $body = $mailMessageFactory->create(__DIR__."/Messages/obsah1.php",
                                            ['doSestavy' => ' ..TOTO TAM DEJ..',
...
//                                       ];
        ...
        $params = (new Params())
                    ...
                    ->setParty  (  (new Party())
                                     ->setFrom('info@najdisi.cz', 'OOOOOOOveletrhprace')
                                     ->addTo($adresat, 'OOOOOOO')
