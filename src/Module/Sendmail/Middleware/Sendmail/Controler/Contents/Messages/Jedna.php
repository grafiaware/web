...
<html>
    <head>
        <meta charset="UTF-8">
        <base>
        <style type="text/css">html {height:100%;} html, body {width:100%;min-height:100%;} 
            body{word-wrap: break-word;border:0;margin:0;padding:3px;box-sizing: 
                     border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor:text; } body::-webkit-scrollbar {width: 10px; height: 10px; background-color: transparent; } body::-webkit-scrollbar-thumb { background-color: #c1c1c1; } body::-webkit-scrollbar-track { background-color: #f5f5f5; border: #f5f5f5; }
                     a:hover {color: #328df7;} a {color: #116cd6; text-decoration: none;}
        </style>
