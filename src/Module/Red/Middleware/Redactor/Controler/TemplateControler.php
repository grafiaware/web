...
use Web\Component\ViewModel\Content\Authored\Paper\PaperTemplatePreviewViewModelInterface;
use Web\Component\ViewModel\Content\Authored\Multipage\MultipageTemplatePreviewViewModel;
use Web\Component\ViewModel\Content\Authored\Multipage\MultipageTemplatePreviewViewModelInterface;

// komponenty
use Web\Component\View\Content\Authored\AuthoredComponentInterface;
    ...
    public function templatesList(ServerRequestInterface $request, $templatesType) {
      ...
      // [ 'title' => 'Vzor - Úvod', 'description' => 'popis',       'url' => 'web/v1/static/uvod'],
       ...
       // [ 'title' => 'Test - namedpaper a3', 'description' => 'rendered component',       'url' => 'red/v1/nameditem/a3'],
        ...
        $templates['author'] = [
        [ 'title' => 'Kontakt', 'description' => 'Grafia web - kontakt',       'url' => 'web/v1/authortemplate/contact'],
        [ 'title' => 'Publikace - novinka', 'description' => 'Grafia web - publikace',   'url' => 'web/v1/authortemplate/eshop_new'],
        [ 'title' => 'Publikace - 2', 'description' => 'Vložení publikací na stránku', 'url' => 'web/v1/authortemplate/eshop_row'],
        [ 'title' => 'Obrázek vlevo a text', 'description' => 'Bez obtékání. Dva sloupce', 'url' => 'web/v1/authortemplate/imgleft_block'],
        [ 'title' => 'Obrázek vpravo a text', 'description' => 'Bez obtékání. Dva sloupce', 'url' => 'web/v1/authortemplate/imgright_block'],
        ...
        [ 'title' => 'Upoutávka na kurz', 'description' => 'popis',       'url' => 'web/v1/authortemplate/teaser_about_item'],
