...
"Konzultujte pracovní příležitosti. Těší se na Vás Kateřina Janků" => ['eventType' => $this->eventType->getEventType('Prezentace'),'title' => "Konzultujte pracovní příležitosti. Těší se na Vás Kateřina Janků",'perex' => "",'institution' => ['id' => '', 'type'=>'', 'name'=>'Konplan'],'party' => '',],
