 ...
 * @author pes2704
 */
class StrankaDaoOLD extends StrankyStareDaoAbstract {
 ...
 */
    ...
    public function get($lang, $list, $publishedOnly=TRUE) {
        $sql = "SELECT list, poradi, {$this->dbObsahName($lang)} AS obsah, {$this->dbNazevName($lang)} AS nazev, aut_gen, editor, zmena "
                . "FROM stranky "
                . "WHERE (list='$list') "
