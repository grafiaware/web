...
class ApiRegistrator {
    ...
    #
        ...
        $registry->register($this->postPrototype->withUrlPattern('/sendmail/v1/assembly/:assembly/campaign/:campaign'));

        
        $registry->register($this->postPrototype->withUrlPattern('/sendmail/v1/sendmailVS'));
