...
/**
 * Tag Paper je custom tag, reálně s ním prohlížeč zachází jako s tagem div. Proto má jako vlatnost atributes použit objekt DivAttributes.
 *
 * @author pes2704
 */
class Paper extends TagAbstract {
