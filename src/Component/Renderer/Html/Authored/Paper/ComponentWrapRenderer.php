 ...
 * @author pes2704
 */
class ComponentWrapRenderer extends HtmlRendererAbstract {

    public function render(iterable $viewModel=NULL) {
        $article = $viewModel->offsetGet('article');
...
//            $paperButton = isset($buttons) ? $buttons->renderPaperButtonsForm($paperAggregate) : "";
            ...
            return Html::tag('div', ['class'=>$this->classMapEditable->getClass('Segment', 'div')],
                Html::tag('div', ['class'=>$this->classMapEditable->getClass('Segment', 'div.paper')], $selectTemplate.$article

                )
            );
        } else {
            return  Html::tag('div', ['class'=>$this->classMapEditable->getClass('Segment', 'div')], $article);
        }
    }
