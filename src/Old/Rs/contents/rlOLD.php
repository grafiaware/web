...
$urlPrefixTemplatesTinyMce = Middleware\Rs\AppContext::getScriptsDirectory().'templates/tinymce/';
...
// TODO: Svoboda - zřejmě se proměnná edit nikde nepoužívá (sloupec editor se nečetl z db) - navíc jde o bezpečnostní riziko - v prohlížeči vidím uživatelské jméno
...
//    } ,
    ...
    templates: [
        ...
        { title: 'Ohraničený blok', description: 'Univerzální šablona pro vytvoření bloků', url: '<?=$urlPrefixTemplatesTinyMce?>kontakt_1.html'}, 
