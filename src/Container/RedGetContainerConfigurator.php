...
use Red\Component\View\Menu\MenuComponentSupervisor;
...
//                }
            ...
            MenuComponentSupervisor::class => function(ContainerInterface $c) {
                $component = new MenuComponentSupervisor($c->get(ComponentConfiguration::class), $c);  // kontejner
                $component->setRendererName(MenuRenderer::class);                
                $component->setRendererContainer($c->get('rendererContainer'));
                return $component;
            },
...
//                    $viewModel->setMaxDepth(2);
            ...
            DriverButtonsComponent::class => function(ContainerInterface $c) {
                ...
                ButtonsMenuItemManipulationComponent::class => function(ContainerInterface $c) {
                    $component = new ButtonsMenuComponent($c->get(ComponentConfiguration::class));
                    /** @var AccessPresentationInterface $accessPresentation */
                    $accessPresentation = $c->get(AccessPresentation::class);
                    if($accessPresentation->isAllowed(ButtonsMenuComponent::class, AccessPresentationEnum::EDIT)) {
...
//                    $component->setRendererName(ItemTypeSelectExtendedRenderer::class);
            ...
            ButtonsItemManipulationComponent::class => function(ContainerInterface $c) {
                ...
                if(!$component->isAllowedToPresent(AccessPresentationEnum::EDIT)) {     //TODO: ??
                    $component->setRendererName(NoPermittedContentRenderer::class);
                }
                $component->setRendererContainer($c->get('rendererContainer'));
                return $component;
    ...
    public function getServicesDefinitions(): iterable {
        return [
            ...
            ComponentRedControler::class => function(ContainerInterface $c) {
                return (new ComponentRedControler(
                        $c->get(StatusSecurityRepo::class),
                        $c->get(StatusFlashRepo::class),
                        $c->get(StatusPresentationRepo::class),
                        $c->get(AccessPresentation::class)
