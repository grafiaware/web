...
class EventsModelContainerConfigurator extends ContainerConfiguratorAbstract {
    ...
    public function getParams(): iterable {
        return [
            ...
            'events.db.account.everyone.name' => PES_RUNNING_ON_PRODUCTION_HOST ? 'najdisicz004' : 'events_everyone',  // nelze použít jméno uživatele použité pro db upgrade - došlo by k duplicitě jmen v build create
            'events.db.account.everyone.password' => PES_RUNNING_ON_PRODUCTION_HOST ? 'najdisicz004' : 'events_everyone',
    ...
    public function getServicesDefinitions(): iterable {
        return [
            ...
            //CompanyInfo
            CompanyInfoDao::class => function(ContainerInterface $c) {
                return new CompanyInfoDao($c->get(Handler::class), $c->get(Sql::class), PdoRowData::class);
            },
            CompanyInfoHydrator::class => function(ContainerInterface $c) {
                return new CompanyInfoHydrator();
            },
            CompanyInfoRepo::class => function(ContainerInterface $c) {
            ...
            CompanyParameterHydrator::class => function(ContainerInterface $c) {
                return new CompanyParameterHydrator();
            },
            CompanyParameterRepo::class => function(ContainerInterface $c) {
