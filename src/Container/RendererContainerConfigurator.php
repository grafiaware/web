            ...
            'paper.headlined.editable.classmap' => function(ContainerInterface $c) {
                return new ClassMap (
                    ['Segment' => [
                     ...
                     'Headline' => [
                        'form div'=>'semafor',
                        'form div i1.published' => 'circle icon green',
                        'form div i1.notpublished' => 'circle icon red ',
                        'form div i2.published' => 'calendar check icon green',
                        'form div i2.notactive' => 'calendar plus icon yellow',
                        'form div i2.notactual' => 'calendar minus icon orange',
                        'form div i2.notactivenotactual' => 'calendar times icon red',
                     ...
                     'Content' => [
                        ...
                        'form div i2.notactivenotactual' => 'calendar times icon red',
                        'form content'=>'',
                        'form content div1'=>'content_edit',
                        'form content div2'=>'pull-out',
                        ],
            ...
            'paper.block.editable.classmap' => function(ContainerInterface $c) {
                return new ClassMap (
                    ['Segment' => [
                     ...
                     'Content' => [
                        'form div'=>'semafor content',
                        'form div i1.published' => 'circle icon green',
                        'form div i1.notpublished' => 'circle icon red ',
                        'form div i2.published' => 'calendar check icon green',
                        'form div i2.notactive' => 'calendar plus icon grey',
                        'form div i2.notactual' => 'calendar minus icon orange',
                        'form div i2.notactivenotactual' => 'calendar times icon red',
                        'form content'=>'',
                        'form content div1'=>'content_edit',
