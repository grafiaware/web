<div class="ui three column stackable grid equal width">
    ...
    <div class="four wide tablet three wide computer column">
        ...
        <script>$("#component_razitko").load("component/rendered/a4");</script>
        </div>
        <div id="component_socialnisite">
        <script>$("#component_socialnisite").load("component/rendered/a5");</script>
        </div>
        <div id="component_aktuality">
        <script>$("#component_aktuality").load("component/rendered/a1");</script>
        </div>
        <div id="component_akce">
        <script>$("#component_akce").load("component/rendered/a2");</script>
        </div>
    </div>
</div>
